(function () {
    ...
    const PLATFORM_DEFS = [
        ...
        { type: 'plataformaFunil3', stateKey: 'plataformas', sprite: '../../assets/fundo/funil3.png', label: 'Funil 3', kind: 'array' },
        { type: 'plataformaFunil4', stateKey: 'plataformas', sprite: '../../assets/fundo/funil4.png', label: 'Funil 4', kind: 'array' },
        { type: 'plataformaFunilPilar', stateKey: 'plataformas', sprite: '../../assets/fundo/funil_pilar.png', label: 'Funil Pilar', kind: 'array' },
        { type: 'plataformaPilar', stateKey: 'plataformas', sprite: '../../assets/fundo/pilar.png', label: 'Pilar', kind: 'array' },
        { type: 'plataformaFundoCanto', stateKey: 'plataformas', sprite: '../../assets/fundo/canto.png', label: 'Canto (Fundo)', kind: 'array' },
        { type: 'plataformaFundoCanto2', stateKey: 'plataformas', sprite: '../../assets/fundo/canto2.png', label: 'Canto 2 (Fundo)', kind: 'array' },
        { type: 'plataformaFundoCanto3', stateKey: 'plataformas', sprite: '../../assets/fundo/canto3.png', label: 'Canto 3 (Fundo)', kind: 'array' },
        { type: 'plataformaFundoCanto4', stateKey: 'plataformas', sprite: '../../assets/fundo/canto4.png', label: 'Canto 4 (Fundo)', kind: 'array' },
        ...
        { type: 'plataformaMetalFundo', stateKey: 'plataformas', sprite: '../../assets/fundo/bloco_metalico_fundo.png', label: 'Metal Fundo', kind: 'array', zIndex: 5 },
