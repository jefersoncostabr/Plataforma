...
function limparCenario() {
    ...
    const elementosParaRemover = palco.querySelectorAll('img:not(#player):not(#player-weapon):not(#player-shield):not(#player-boots):not(#player-parachute):not(#player-jetpack):not(#player-jet-fire)');
